...
public class ThroughputCalculatorCallback extends BasicCallbacks {
  ...
  public void acknowledged(EventBatch events) {
    ...
    LOG.info("ThroughputCalculatorCallback Batch acknowledged with last_latency={}, total_batches_acked={}, num_outstanding_batches={}, outstanding_batches={}", 
            lastLatency, ackedCount.get(), batchSizes.size(), batchSizes);
