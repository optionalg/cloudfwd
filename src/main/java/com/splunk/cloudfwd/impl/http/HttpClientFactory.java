...
public final class HttpClientFactory {
    ...
    public static int INITIAL_MAX_CONN_PER_ROUTE = 8; //Initial value. See HttpClientWrapper.adjustConnPoolSize for dyamic behavior
    public static int INITIAL_MAX_CONN_TOTAL = 8; //Initial value. See HttpClientWrapper.adjustConnPoolSize for dyamic behavior
