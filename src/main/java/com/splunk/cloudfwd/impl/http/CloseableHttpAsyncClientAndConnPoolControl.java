...
public class CloseableHttpAsyncClientAndConnPoolControl {
    ...
    private void adjustConnPoolSize(){                
        this.connPoolControl.setDefaultMaxPerRoute(Math.max(referenceHolders.size()*10,HttpClientFactory.INITIAL_MAX_CONN_PER_ROUTE));
        ...
        this.connPoolControl.setMaxTotal(Math.max(referenceHolders.size()*8,HttpClientFactory.INITIAL_MAX_CONN_TOTAL));
    }    
