...
public class EventBatchResponse extends Response implements EventBatchLifecycleEvent{
  private EventBatchImpl events = null;
    
  public EventBatchResponse(Type eventType, int httpCode, String resp, EventBatchImpl events, String url) {
    super(eventType, httpCode, resp, url);
    this.events = events;
