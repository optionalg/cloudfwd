 ...
 * @author ghendrey
 */
public class PropertiesFileHelperOld extends ConnectionSettings{

  private static final Logger LOG = LoggerFactory.getLogger(PropertiesFileHelperOld.class.getName());

  public PropertiesFileHelperOld(ConnectionImpl c, Properties overrides) {
      super(c, overrides);
  }
   ...
   */
  public PropertiesFileHelperOld(ConnectionImpl c) {
    super(c);
  }
