...
4. In `cloudfwd.properties`, set your HEC endpoint URL(s) and your generated HEC token. You can also put an ELB destination or multiple host destinations as the url. 
5. Save your changes.
